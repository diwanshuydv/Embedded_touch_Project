...
void lcd_show_frame(void)
{
	...
	/* Disable double buffering for direct drawing */
	// t = display_frame;
	...
	// Send cur_frame which we are continuously updating
	lcd_command(0x2C, 0, FRAME_SIZE_BYTES, (const uint8_t *)cur_frame);
}
